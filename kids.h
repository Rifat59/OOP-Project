...
void toys::user_kids()
{
    ...
    while(1)
    {
        vector<string>st1;///stl
        st1.push_back( "_____________Select your items :");
        for_each(st1.begin(),st1.end(), [] (string y)///lamda
        {
            cout<<"\n\n"<<y;
        });
        cin>>str;
